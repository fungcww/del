Namespace Model.Claims
    Public Class MinorClaimMasterRow
        ...
        Public Property rcsreg_case_no As String
    End Class

    Public Class MinorClaimMaster
        Public Property mcsvw_claim_header_details As List(Of MinorClaimMasterRow)
    End Class
End Namespace