...
Public Class ctrl_VisitCS
    ...
    Private blnIsTAD2C As Boolean = False
...
#End Region
    ...
    Public Sub checkVisitCSFlag()
        ...
        'Dim objVisitCSResponse As CRS_Util.clsJSONBusinessObj.clsVisitCSFlagResponse = CRS_Util.clsJSONTool.CallCheckVisitCSWS("25097990", "29100633", Me.Lang)
        ...
        If objVisitCSResponse.msg.resultCode = "0" Then 'success
            ...
            strCsFlag = IIF(blnIsTAD2C, "Y", Flag)
    ...
    Public Sub RefreshDisplay()
        Me.lblUpdDateValue.Text = strUpdDate
        Me.lblUpdUserValue.Text = strUpdUser
        Me.cboCsFlag.SelectedItem = IIf(strCsFlag = "U", "N/A", strCsFlag)
        Dim boolLAS = Convert.ToBoolean(System.Configuration.ConfigurationSettings.AppSettings.Item("IsLAS"))
        Me.btnChange.Enabled = IIf(boolLAS, False, IIF(blnIsTAD2C, False, True)) 'enable for CRS, disable for LAS, disable for TAD2C Policy
    End Sub
