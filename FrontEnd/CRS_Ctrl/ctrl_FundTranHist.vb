...
#End Region
    ...
    Private Sub ShowDetail()
        ...
        Dim isAsur As Boolean = IIF(objDBHeader.CompanyID = "LAC" Or objDBHeader.CompanyID = "LAH", True, False)
        ...
        If clsCRS.GetFundTxHist(strPolicyNo, strTxType, strTxID, strLA, dsReceData, strErr) Then
            If strTxType = "ULB" Or strTxType = "ULS" Or strTxType = "Fund Switching" Or strTxType = "Partial Surrender" Then
                ...
                If dsReceData.Tables.Contains("SwitchOut") Then
                    ...
                    dgSwitchOut.Columns(2).HeaderText = "Switch Out %" : dgSwitchOut.Columns(2).Width = 100 : dgSwitchOut.Columns(2).Visible = Not isAsur
                    ...
                    dgSwitchOut.Columns(4).HeaderText = IIf(isAsur, "Units to be surrendered", "Switch Out Units") : dgSwitchOut.Columns(4).Width = 90
