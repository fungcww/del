                ...
                If dsPoInfo.Tables.Count > 0 Then
                    If dsPoInfo.Tables(0).Rows.Count > 0 Then
                        ...
                        If strIAProd.Substring(0, 2) = "IW" Or strIAProd.Substring(0, 2) = "VI" Or strIAProd.Substring(0, 2) = "WI" Or strIAProd.Substring(0, 2) = "VH" Or strIAProd.Substring(0, 2) = "VU" _
                                ...
                                Or strIAProd.Substring(0, 2) = "KU" _
                                Or strIAProd.Substring(0, 2) = "LD" Or strIAProd.Substring(0, 2) = "LG" Or strIAProd.Substring(0, 2) = "LF" Or strIAProd.Substring(0, 2) = "LE" Or strIAProd.Substring(0, 2) = "L9" _
                                Or strIAProd.Substring(0, 2) = "L7" Or strIAProd.Substring(0, 2) = "L6" Or strIAProd.Substring(0, 2) = "LC" Or strIAProd.Substring(0, 2) = "L2" Or strIAProd.Substring(0, 2) = "L3" _
                                Or strIAProd.Substring(0, 2) = "L4" Or strIAProd.Substring(0, 2) = "L1" _ 
                                Then
