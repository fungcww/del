...
#End Region
    ...
    Private Sub frmMarkinHistMcu_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            Using wsCRS As New CRSWS.CRSWS()
                ...
                'If Not wsCRS.GetMarkinHist(getCompanyCode(g_McuComp), getEnvCode(), strPolicy, dtPOLALT, strErrMsg) Then
                '    MsgBox("System Error." & vbCrLf & strErrMsg, MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, "Error")
                '    Exit Sub
                'End If
                Dim retDs1 As DataSet = APIServiceBL.CallAPIBusi(getCompanyCode(g_McuComp), "CHECK_MARK_IN_HIST", New Dictionary(Of String, String)() From {{"strInPolicy", strPolicy}})
