...
#End Region
    ...
    Private Sub buildUI()
        ...
        If isLA = True Then
            ...
            dtVal = GetLAPolicyValueMcu(strPolicy, "P", 0, strErr, txtValDate.Value)
    ...
    ' **** ES009 Begin ****
    Private Function MSClaimAmount(ByVal PolicyAccID As String, ByVal EffDate As Date,
