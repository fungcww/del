...
Public Class AgentInfo
    ...
    Friend WithEvents grdAgentHistory As DataGrid
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        grbCSR.Enabled = CheckUPSAccess("Assign Servicing CSR")
        blnCanViewCSA = CheckUPSAccess("View Servicing CSR")
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grdAgentHistory = New System.Windows.Forms.DataGrid()
        CType(Me.grdAgentHistory, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'grdAgentHistory
        '
        Me.grdAgentHistory.ReadOnly = True
        Me.grdAgentHistory.AlternatingBackColor = System.Drawing.Color.White
        Me.grdAgentHistory.BackColor = System.Drawing.Color.White
        Me.grdAgentHistory.BackgroundColor = System.Drawing.Color.Ivory
        Me.grdAgentHistory.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.grdAgentHistory.CaptionBackColor = System.Drawing.Color.DarkSlateBlue
        Me.grdAgentHistory.CaptionForeColor = System.Drawing.Color.Lavender
        Me.grdAgentHistory.CaptionVisible = False
        Me.grdAgentHistory.DataMember = ""
        Me.grdAgentHistory.FlatMode = True
        Me.grdAgentHistory.Font = New System.Drawing.Font("Tahoma", 8.0!)
        Me.grdAgentHistory.ForeColor = System.Drawing.Color.Black
        Me.grdAgentHistory.GridLineColor = System.Drawing.Color.Wheat
        Me.grdAgentHistory.HeaderBackColor = System.Drawing.Color.CadetBlue
        Me.grdAgentHistory.HeaderFont = New System.Drawing.Font("Tahoma", 8.0!, System.Drawing.FontStyle.Bold)
        Me.grdAgentHistory.HeaderForeColor = System.Drawing.Color.Black
        Me.grdAgentHistory.LinkColor = System.Drawing.Color.DarkSlateBlue
        Me.grdAgentHistory.ParentRowsBackColor = System.Drawing.Color.Ivory
        Me.grdAgentHistory.ParentRowsForeColor = System.Drawing.Color.Black
        Me.grdAgentHistory.SelectionBackColor = System.Drawing.Color.Wheat
        Me.grdAgentHistory.SelectionForeColor = System.Drawing.Color.DarkSlateBlue
        Me.grdAgentHistory.Location = New System.Drawing.Point(4, 447)
        Me.grdAgentHistory.Name = "grdAgentHistory"
        Me.grdAgentHistory.Size = New System.Drawing.Size(754, 180)
        Me.grdAgentHistory.TabIndex = 96
        '
        'AgentInfo
        '
        Me.Controls.Add(Me.grdAgentHistory)
        ...
        Me.Name = "AgentInfo"
        Me.Size = New System.Drawing.Size(720, 542)
        CType(Me.grdAgent, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.grdAgentHistory, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Public Sub buildUI()
        ...
        'strSQL = "select space(10) as csrid, space(25) as name union all Select distinct csrid, name From " & serverPrefix & "CSR where active = 'Y' order by name"
        'LoadComboBox(dtCSRF, cboCSR, "csrid", "name", strSQL)
        ...
        '    Else
        '        'strSQL = " select " & _
        '        '         " caid.camaid_agent_no as cswagi_agent_code, caid.camaid_sort_key as cswagi_unit_code, crrt.Camrrt_loc_code as cswagi_loc_code, caid.camaid_date_join as cswagi_contract_date, " & _
        '        '         " caid.camaid_date_left as cswagi_date_left, caid.camaid_grade as cswagi_grade, cgm.camgms_grade_short_desc as cswagi_desc, bm.camaib_disp_name as cswagi_mgr_name, " & _
        '        '         " caia.camaia_res_phone as cswagi_res_phone, caia.camaia_mob_phone as cswagi_mob_phone, caia.camaia_bus_phone as cswagi_bus_phone, caia.camaia_fax as cswagi_fax,  " & _
        '        '         " caia.camaia_email as cswagi_email, ba.camaib_idno as cswagi_idno " & _
        '        '         " from " & _
        '        '         cSQL3 & "." & g_CAM_Database & ".dbo.cam_agent_info_dirmgr caid " & _
        '        '         " Inner join " & cSQL3 & "." & g_CAM_Database & ".dbo.cam_grade_master cgm " & _
        '        '         " on caid.camaid_channel_code = cgm.camgms_channel_code and caid.camaid_dms_grade = cgm.camgms_grade_code " & _
        '        '         " Inner join " & cSQL3 & "." & g_CAM_Database & ".dbo.cam_Agent_info_address caia " & _
        '        '         " on caid.camaid_Agent_no = caia.camaia_agent_no " & _
        '        '         " Inner join " & cSQL3 & "." & g_CAM_Database & ".dbo.cam_rdbu_rel_tab crrt " & _
        '        '         " on caid.camaid_sort_key = crrt.camrrt_agency_code and crrt.camrrt_section_no = '00000' " & _
        '        '         " Inner join " & cSQL3 & "." & g_CAM_Database & ".dbo.cam_agent_info_basic ba " & _
        '        '         " on caid.camaid_agent_no = ba.camaib_agent_no " & _
        '        '         " Inner join " & cSQL3 & "." & g_CAM_Database & ".dbo.cam_agent_info_basic bm " & _
        '        '         " on bm.camaib_agent_no = case when caid.camaid_grade between 4 and 12 then crrt.camrrt_dir_agtno else crrt.camrrt_agent_no end " & _
        '        '         " Where caid.camaid_agent_no in (" & strAgtList & "); "

        '        'Dim dtAgentInfo As New DataTable()
        '        'If GetAgentInfo(strAgtList, dtAgentInfo, strErr) Then
        '        '    'Dim dtAgentInfo As New DataTable()
        '        '    'dtAgentInfo = tempdtAgentInfo.Copy()
        '        '    dtAgentInfo.TableName = "cswvw_agent_info"
        '        '    ds.Tables.Add(dtAgentInfo)
        '        'End If
        ...
        If GetAgentInfoRelatedTables(strPolicy, strAgtList, tempDsAgentInfoRelatedTable, strErr) Then
        ...
        Dim relPolicyAcRel As New Data.DataRelation("PolicyAcRel", ds.Tables("PolicyAccountRelationCodes").Columns("PolicyAccountRelationCode"),
            ds.Tables("AgentList").Columns("PolicyRelateCode"), True)

        Dim relNA As New Data.DataRelation("NARel", ds.Tables("ORDUNA").Columns("ClientID"),
            ds.Tables("AgentList").Columns("ClientID"), True)

        Dim relAgtInfo As New Data.DataRelation("AgtInfoRel", ds.Tables("cswvw_agent_info").Columns("cswagi_agent_code"),
        ...
        Dim relCommInfo As New Data.DataRelation("CommInfo", ds.Tables("AgentCodes").Columns("AgentCode"),
            ds.Tables("AgentList").Columns("AgentCode"), True)
...
#Region "Agent History"
            Dim dtAgentHistory As New DataTable("AgentHistory")
            If GetAgentHistory(strPolicy, dtAgentHistory, strErr) Then
                grdAgentHistory.DataSource = dtAgentHistory
            End If
#End Region
    ...
    '                strSQL = "Insert csw_cs_policy_list " &
    '                    " (cswcpl_policy_no, cswcpl_agent_no, cswcpl_csr, cswcpl_unit_code, cswcpl_remark, cswcpl_create_user, cswcpl_create_date, cswcpl_update_user, cswcpl_update_date) " &
    ...
    '                strSQL = "Update csw_cs_policy_list " &
    '                    " Set cswcpl_csr = '" & Trim(cboCSR.SelectedValue) & "', " &
    '                    "     cswcpl_remark = '" & Trim(txtRemark.Text) & "', " &
    '                    "     cswcpl_update_user = '" & gsUser & "', " &
    '                    "     cswcpl_update_date = GETDATE() " &
    ...
    Private Function InsertCSRRecord(ByVal strPolicy As String, ByVal strSA As String, ByVal cboCSR As String, ByVal strSAB As String, ByVal txtRemark As String) As Boolean
        ...
        Try
            APIServiceBL.ExecAPIBusi(getCompanyCode(), "INSERT_CSR_RECORD",
    ...
    Private Function UpdateCSRRecord(ByVal strPolicy As String, ByVal cboCSR As String, ByVal txtRemark As String) As Boolean
        Dim isUpdate As Boolean = False
        Try
            APIServiceBL.ExecAPIBusi(getCompanyCode(), "UPDATE_CSR_RECORD",
                                New Dictionary(Of String, String) From {
                                {"strPolicy", strPolicy},
                                {"cboCSR", If(Not String.IsNullOrEmpty(cboCSR), cboCSR, " ")},
                                {"txtRemark", If(Not String.IsNullOrEmpty(txtRemark), txtRemark, " ")},
