...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtAppDate.Location = New System.Drawing.Point(96, 4)
        ...
        Me.txtRecvDate.Location = New System.Drawing.Point(96, 28)
        ...
        Me.txtInforce.Location = New System.Drawing.Point(256, 28)
        ...
        Me.txtRCD.Location = New System.Drawing.Point(256, 4)
        ...
        Me.txtDelDate.Location = New System.Drawing.Point(456, 4)
        ...
        Me.txtFLDate.Location = New System.Drawing.Point(456, 28)
        ...
        Me.Label5.Location = New System.Drawing.Point(220, 8)
        ...
        Me.grdUW.Location = New System.Drawing.Point(4, 54)
        Me.grdUW.Name = "grdUW"
        ...
        Me.txtFLD.Location = New System.Drawing.Point(632, 4)
        ...
        Me.Label7.Location = New System.Drawing.Point(544, 8)
        ...
        Me.txtOutstand.Location = New System.Drawing.Point(84, 186)
        ...
        Me.txtStatus.Location = New System.Drawing.Point(456, 186)
        ...
        Me.Label9.Location = New System.Drawing.Point(412, 190)
        ...
        Me.txtRemark.Location = New System.Drawing.Point(84, 210)
        ...
        Me.txtUWS.Location = New System.Drawing.Point(84, 236)
...
#End Region
    ...
    Private Function GetWebServiceClient() As CommonWS.Service
        ...
        CNBComHeader.CompanyID = g_McuComp 'g_Comp
        CNBComHeader.EnvironmentUse = g_McuEnv 'g_Env
    ...
    Private Sub buildUI()
        ...
        Dim dtPendingAgent As DataTable
        ...
        Using wsCRS As New CRSWS.CRSWS
            'Human 401 unauthorized issue fix
            wsCRS.Credentials = System.Net.CredentialCache.DefaultCredentials
            wsCRS.Timeout = 10000000
            dtPendingAgent = wsCRS.getPendingAgtCode(getCompanyCode(g_McuComp), getEnvCode(), strPolicy, strErr)

            If Not dtPendingAgent Is Nothing AndAlso dtPendingAgent.Rows.Count > 0 Then
                PendingAgtCd = dtPendingAgent.Rows(0).Item("AgentCode")
            End If

            If wsCRS.GetNBRPolicyMcu(getCompanyCode(g_McuComp), getEnvCode(), strPolicy, strErr) Then
        ...
        'If GetDT(strSQL, strCIWConn, dtPendingAgent, strErr) Then
        '    If Not dtPendingAgent Is Nothing AndAlso dtPendingAgent.Rows.Count > 0 Then
        '        PendingAgtCd = dtPendingAgent.Rows(0).Item("AgentCode")
        '    End If
        'End If

        'If GetNBRPolicyMcu(strPolicy, strErr) Then
        '    IsCNB = True
        '    getPendingRequestItems(PendingAgtCd, PendingItems, UWComment, strErr, strPolicy)
        '    If strErr <> "" Then
        '        MsgBox(strErr, MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, "Error")
        ...
        If IsCNB Then
            ...
            Using wsCRS As New CRSWS.CRSWS
                wsCRS.Credentials = System.Net.CredentialCache.DefaultCredentials
                wsCRS.Timeout = 10000000
                ds = wsCRS.getMcuPolicyUW(getCompanyCode(g_McuComp), getEnvCode(), strPolicy, ds, strErr)
        ...
        Else
            ...
            Using wsCRS As New CRSWS.CRSWS
                wsCRS.Credentials = System.Net.CredentialCache.DefaultCredentials
                wsCRS.Timeout = 10000000    
                ds = wsCRS.getMcuUWOutstandingReq(getCompanyCode(g_McuComp), getEnvCode(), strPolicy, gcMcuNBR, ds, strErr)
