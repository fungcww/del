Public Class PolicyAltPendingMcu
...
#End Region
    ...
    Private Sub BuildUI()
        ...
        Try
            Using wsCRS As New CRSWS.CRSWS()
                ...
                'If Not wsCRS.GetPendingMarkin(getCompanyCode(g_McuComp), getEnvCode("POS"), strPolicy, dtPOLALT, strErrMsg) Then
                '    MsgBox("System Error." & vbCrLf & strErrMsg, MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, "Error")
                '    Exit Sub
                'End If
                Dim retDs1 As DataSet = APIServiceBL.CallAPIBusi(getCompanyCode(g_McuComp), "GET_PENDING_MARK_IN", New Dictionary(Of String, String)() From {{"strInPolicy", strPolicy}})
    ...
    Private Sub cmdHistory_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdHistory.Click
        ...
        Dim f As New frmPendingHistMcu
