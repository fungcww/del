Public Class frmPostSalesQuestionnaireMaster
    ...
    Private Sub Init()
        ...
        Try
            If Not RetrievePostSalesCallQuestions(getCompanyCode(Me.objDBHeader.CompanyID), dtQuestions) Then
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        bsQuestions.AddNew()
        CType(bsQuestions.Current, DataRowView)("cswpsq_question_id") = 0
    ...
    Private Function Save() As Boolean
        ...
        If SavePostSalesCallQuestion(getCompanyCode(Me.objDBHeader.CompanyID), Me.objDBHeader.UserID, formMode, dtData) = False Then
            'MsgBox(strErr, MsgBoxStyle.Critical, "Error")
            Return False
        End If
