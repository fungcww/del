Public Class frmPostSalesCallProductSettingMcu
    ...
    Private Sub LoadData()
        ...
        '    'If Not wsCRS.RetrievePostSalesCallProductSettings(dsSetting, strErr) Then
        ...
        If RetrievePostSalesCallProductSettings(Me.objDBHeader.CompanyID, tempDs) Then
            ...
            Try
                ' oliver 2023-12-14 updated for data in the productid column in the csw_post_sales_call_product_setting table and the csw_post_sales_call_product_questions table do not mapping
                dsSetting.Relations.Add("productQuestionRel", dsSetting.Tables("Products").Columns("cswpsd_ProductID"), dsSetting.Tables("Questions").Columns("cswpsn_ProductID"), False)
    ...
    Private Function Save() As Boolean
        ...
        Select Case formMode
            Case FormModeEnum.AddNew
                ...
                If AddPostSalesCallProductSetting(getCompanyCode(g_McuComp), dtData, Me.objDBHeader.UserID) = False Then
                    'MsgBox(strErr, MsgBoxStyle.Critical, "Error")
                    Return False
                End If
            ...
            Case FormModeEnum.Modify
                ...
                If UpdatePostSalesCallProductSetting(getCompanyCode(g_McuComp), dtData, Me.objDBHeader.UserID) = False Then
                    'MsgBox(strErr, MsgBoxStyle.Critical, "Error")
                    Return False
                End If
    ...
    Private Sub cmdQuestionAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdQuestionAdd.Click
        ...
        Using frmQuestionSelect As New frmPostSalesQuestionnaireMaster(FormModeEnum.Select)
            ...
            If Not AddPostSalesCallProductQuestion(dt, Me.objDBHeader.UserID, blnExists, getCompanyCode(g_McuComp)) Then
                'MsgBox(strErr, MsgBoxStyle.Critical, "Error")
                Return
            End If
    ...
    Private Sub cmdQuestionRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdQuestionRemove.Click
        ...
        If Not RemovePostSalesCallProductQuestion(getCompanyCode(g_McuComp), drv("cswpsn_ProductID").ToString().Trim(), drv("cswpsn_question_id")) Then
            'MsgBox(strErr, MsgBoxStyle.Critical, "Error")
            Return
        End If
