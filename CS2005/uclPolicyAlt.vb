...
#End Region
    ...
    Private Sub BuildUI()
        ...
        Dim retDs1 As DataSet = APIServiceBL.CallAPIBusi(getCompanyCode(), "CHECK_MARK_IN", New Dictionary(Of String, String)() From {{"strInPolicy", strPolicy}})
