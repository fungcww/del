...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents uclCustomer As CS2005.Personal_Asur
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.uclCustomer = New CS2005.Personal_Asur
        ...
        Me.TabPage1.Text = "Personal_Asur"
        '
        'uclCustomer
        '
...
#End Region
    ...
    Private Sub ViewDocInWebbrowser(ByVal strDocLoc As String)
        ...
        'With od
        '.InitialDirectory = Environment.GetFolderPath(Environment.SpecialFolder.Personal_Asur)
    ...
    Private Function LockRecord(ByVal strCampaignID As String, ByVal strChannelID As String, ByVal strCustomerID As String,
    ...
    Private Function UnLockRecord(ByVal strCampaignID As String, ByVal strChannelID As String, ByVal strCustomerID As String,
                                                ByRef strErrMsg As String) As Boolean
        Dim sqlConn As SqlClient.SqlConnection = New SqlClient.SqlConnection
        Dim sqlCmd As SqlCommand
        Dim strSQL As String
