Public Class uclPostSalesCallQuestionnaireMcu
    ...
    Public Sub RetrieveInfo()
        ...
        If Not GetCoverage(getCompanyCode(g_McuComp), policyNo, dtCoverage) Then
            'MsgBox(strErr, MsgBoxStyle.Critical, "Error")
            Return
        End If
        ...
        If Not RetrievePostSalesCallPolicyQuestion(policyNo, dtQuestion, strErr, getCompanyCode(g_McuComp)) Then
            MsgBox(strErr, MsgBoxStyle.Critical, "Error")
            Return
        End If
    ...
    Private Function Save() As Boolean
        ...
        If Not SavePostSalesCallPolicyAnswer(dtQuestion, objDBHeader.UserID, getCompanyCode(g_McuComp)) Then
            'MsgBox(strErr, MsgBoxStyle.Critical, "Error")
            Return False
        End If
    ...
    ''' <summary>
    ''' CheckPostSalesCallCompleted, Check the PostSales Call
    ...
    Public Sub CheckPostSalesCallCompleted()
        ...
        'This already move to the api config.
        'Dim strServiceEventCategory As String = "'86', '88', '93', '91'"

        Dim retRow As DataRow = APIServiceBL.QueryFirstRow(g_Comp, "FRM_CHECK_POSTSALESCALL_COMPLETED", New Dictionary(Of String, String)() From {
                {"strPolicy", Trim(Me.PolicyAccountID)}
                }, True)

        If Not IsNothing(retRow) AndAlso
           retRow("EventStatusCode").ToString.Trim = "C" AndAlso
           retRow("EventTypeCode").ToString().Trim() <> "10" AndAlso
           retRow("EventTypeCode").ToString().Trim() <> "20" Then
