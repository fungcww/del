...
#End Region
    ...
    Private Sub frmMarkinHist_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim retDs1 As DataSet = APIServiceBL.CallAPIBusi(getCompanyCode(strCompany), "GET_PENDING_MARK_IN_HIST", New Dictionary(Of String, String)() From {{"strInPolicy", strPolicy}})
