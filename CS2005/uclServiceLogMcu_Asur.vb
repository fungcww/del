...
Public Class uclServiceLogMcu_Asur
    ...
    Friend WithEvents rbMcu As RadioButton
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.rbMcu = New System.Windows.Forms.RadioButton()
        ...
        Me.chkFollowUp.Location = New System.Drawing.Point(1419, 620)
        ...
        Me.gbPiEservicesAuth.TabIndex = 135
        ...
        Me.txtCustomerID.Size = New System.Drawing.Size(464, 26)
        ...
        Me.txtCustomerName.Size = New System.Drawing.Size(464, 26)
        ...
        Me.rad_SuitabilityMisMatch.TabIndex = 131
        ...
        Me.Panel1.Controls.Add(Me.rbMcu)
        ...
        Me.rbEB.Location = New System.Drawing.Point(168, 8)
        ...
        Me.rbGI.Location = New System.Drawing.Point(103, 8)
        ...
        'rbMcu
        '
        Me.rbMcu.AutoSize = True
        Me.rbMcu.Checked = True
        Me.rbMcu.Location = New System.Drawing.Point(14, 8)
        Me.rbMcu.Margin = New System.Windows.Forms.Padding(4, 5, 4, 5)
        Me.rbMcu.Name = "rbMcu"
        Me.rbMcu.Size = New System.Drawing.Size(82, 24)
        Me.rbMcu.TabIndex = 14
        Me.rbMcu.TabStop = True
        Me.rbMcu.Text = "Macau"
        Me.rbMcu.UseVisualStyleBackColor = True
        '
        ...
        Me.rad_ILASPostSalseCall.TabIndex = 129
        ...
        Me.rad_VCPostSalesCall.TabIndex = 128
        ...
        Me.rad_NVCWelcomeCall.TabIndex = 127
        ...
        Me.lbl_PostCallCount.TabIndex = 126
        ...
        Me.lbl_PostCallStatus.TabIndex = 124
        ...
        Me.lbl_InforceDate.TabIndex = 122
        ...
        Me.txtDownloadPostSalesCall.TabIndex = 117
        ...
        Me.cbStatus.Size = New System.Drawing.Size(279, 28)
        ...
        Me.cbReceiver.Size = New System.Drawing.Size(443, 28)
        ...
        Me.cbInitiator.Size = New System.Drawing.Size(443, 28)
        ...
        Me.grpServiceEvent.TabIndex = 106
        ...
        Me.cbEventCat.Size = New System.Drawing.Size(395, 28)
        ...
        Me.cbEventDetail.Size = New System.Drawing.Size(395, 28)
        ...
        Me.cbEventTypeDetail.Size = New System.Drawing.Size(395, 28)
        ...
        Me.cbMedium.Size = New System.Drawing.Size(395, 28)
        ...
        Me.Size = New System.Drawing.Size(1700, 776)
...
#End Region
    ...
    Private Sub InitDataset()
        ...
        sqlConn.ConnectionString = GetConnectionStringByCompanyID(g_McuComp)
        ...
        strSQL = "Select (Case when event.sort_order is null then star.sort_order else event.sort_order end) as 'Status', " &
                         ...
                         "t1.*, ProductName=case when t2.companyid in ('EAA','ING','BMU') then isnull(t3.Description,'') else '' end " &
             ...
             "left join CSR t8 on t1.MasterCSRID=t8.CSRID " &
             ...
             "left join EventStatusCodes as star on star.EventStatusCode = t1.EventStatusCode and star.CategoryCode= '*' and star.EventTypeCode = '*' " '& _
        ...
        daStatus = New SqlDataAdapter("Select * from EventStatusCodes", sqlConn)
        strSQL = "(Select '' as 'CSRID', '' as 'Name', null as 'CSRTypeCode', null as 'Description', " &
                 ...
                 "From CSR) union (Select * From CSR) order by Name"
...
#End Region
    ...
    Private Sub SaveServiceLog(ByVal dr As DataRow)
        ...
        strInsSQL = "declare @no as numeric(15,0); " &
                    ...
                    "Insert Into ServiceEventDetailMCU_Extend (ServiceEventNumber,PolicyAccountID,FollowUpByMacau )values ((@no+1), '" & dr.Item("PolicyAccountID") & "', '" & IIf(chkFollowUp.Checked, "1", "0") & "');"
        'C001 - End
        ...
        strUpdSQL = "Update ServiceEventDetail set " &
                    ...
                    "Where ServiceEventNumber = " & dr.Item("ServiceEventNumber") & "; " &
                    "Update ServiceEventDetailMCU_Extend set FollowUpByMacau = '" & IIf(chkFollowUp.Checked, "1", "0") & "' " &
                    "where ServiceEventNumber = '" & dr.Item("ServiceEventNumber") & "' " &
...
#End Region
    ...
    Private Function isInForce() As Boolean
        ...
        If Not sqlConn2.State = ConnectionState.Open Then
            sqlConn2.ConnectionString = GetConnectionStringByCompanyID(g_McuComp)
            sqlConn2.Open()
        End If
